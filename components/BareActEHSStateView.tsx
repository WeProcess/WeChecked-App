...
const BareActEHSStateView = (props: SnameProps) => {
  ...
  async function getbare() {
    try {
      const response_var = await fetch(
        "https://karmamgmt.com/wecheckbetav0.1/app_new_php/bare_ehs_state_view.php",
        {
          method: "POST",
          headers: {
...
export default BareActEHSStateView;
